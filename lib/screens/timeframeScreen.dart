...
class sportSelectionScreenState extends State<sportSelectionScreen> {
  ...
  deleteTimeFrameRow(){
    setState(() {
      _timeFrames.removeAt(dayAndTimeSettingsAmount-1);
      dayAndTimeSettingsAmount = dayAndTimeSettingsAmount - 1;
    });
  }
  ...
  Widget SportenForm(){
    // Map<int, timeFrameWidget> _timeFramesMap = new List.generate(length, (index) => null)
    _timeFrames = new List.generate(dayAndTimeSettingsAmount, (index) => new timeFrameWidget());
    // MappedList = Map.fromIterable(_timeFrames, key: (v) => v[0], value: (v) => v[1]);
    return Form(
        key: _formKey,
        child: Column(
          children: <Widget>[
              ...
              children: [
                Container(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text("Verwijder laatste rij"),
                  ),
                ),
                Container(
                  padding: EdgeInsets.all(16),
