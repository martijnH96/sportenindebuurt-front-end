import 'package:Sporten_in_de_buurt/sport/sport_app_theme.dart';
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: SportAppTheme.buildLightTheme().dividerColor,
                      ),
                    ),
                    child: Material(
          ...
          child: Center(
            child: Text(
              ...
              style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
                  color: SportAppTheme.buildLightTheme().primaryColor),
            ),
          ),
        ),
      );
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: getIsItStartAndEndDate(date)
                                  ? SportAppTheme.buildLightTheme().primaryColor
                                  : Colors.transparent,
                              borderRadius:
                                  const BorderRadius.all(Radius.circular(32.0)),
                              border: Border.all(
